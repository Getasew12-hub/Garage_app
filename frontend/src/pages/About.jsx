        ...
        <div className="surviceTestomon backgroundDiv lg:flex-row! lg:text-start! ">
          ...
          <div className="space-y-6">
            ...
            <p>
              ...
              consectetur! Quidem nostrum dolor, labore iusto dignissimos
              pariatur iste doloribus? Quis impedit error porro eligendi
              doloremque ratione aperiam esse quos voluptate!
            </p>
          </div>
        </div>
        <div className="surviceTestomon backgroundDiv lg:flex-row!  lg:text-start!">
