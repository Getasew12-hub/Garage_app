            ...
            <tbody>
              {services.map((val, index) => (
                <tr className="border border-gray-500 " key={index}>
                  ...
                  <td
                    className={`p-2.5 ${val.status === "in-progress" && "text-yellow-500"} ${val.status === "booked" && "text-blue-500"} ${val?.status === "canceled" && "text-red-500"} ${val.status === "completed" && "text-green-500"}  `}
                  >
                    {val.status}
                  </td>
                  <td className=" p-2.5">
                    <div>
                      <select
                        ...
                        className="border border-gray-500 py-1 px-2 rounded "
